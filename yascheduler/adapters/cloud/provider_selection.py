# FILE: yascheduler/adapters/cloud/provider_selection.py
# VERSION: 1.1.0
...
#   LAST_CHANGE: v1.1.0 - Extract _adapter_supports_any_platform helper from nested any(any(...)) for readability and early-break short-circuit (review-hardening).
#   PREVIOUS_CHANGE: v1.0.0 - Extract from CloudProvisionerImpl._select_best_provider (cloud-provisioner-pure). Replace DB read with current_counts param.
# END_CHANGE_SUMMARY
