...
The `PostgresDbConfig` frozen value object for PostgreSQL connection settings,
defined as a stdlib dataclass in the persistence subpackage with intra-package
imports.
