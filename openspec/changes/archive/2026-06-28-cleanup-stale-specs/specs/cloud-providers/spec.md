...
- **THEN** the import is `from yascheduler.infra.cloud import ConfigCloudAzure, AzureImageReference` (R2 facade path), not `from yascheduler.config import ...` and not `from yascheduler.infra.cloud.cloud_configs import ...` (deep path, R2 violation)
