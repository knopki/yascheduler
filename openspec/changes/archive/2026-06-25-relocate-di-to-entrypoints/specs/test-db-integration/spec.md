...
The test SHALL NOT patch any internal collaborator
(`yascheduler.entrypoints.di.make_cli_deps` or otherwise). It exercises
the full facade path through real Postgres (characterization-first golden
master).
