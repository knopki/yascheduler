...
#   SCOPE: Re-export AbstractUnitOfWork, Orchestrator, MessageBus, submit_task, query_tasks.
#   DEPENDS: M-APPLICATION-UOW, M-APPLICATION-ORCHESTRATOR, M-APPLICATION-MESSAGE-BUS, M-APPLICATION-SUBMIT, M-APPLICATION-QUERY-TASKS, M-APPLICATION-ALLOCATION-TRACKER
#   LINKS: M-APPLICATION-UOW, M-APPLICATION-SUBMIT, M-APPLICATION-QUERY-TASKS, M-APPLICATION-ORCHESTRATOR, M-APPLICATION-MESSAGE-BUS, M-DI, M-APPLICATION-ALLOCATION-TRACKER
# END_MODULE_CONTRACT
#
# START_MODULE_MAP
...
#   LAST_CHANGE: v1.4.0 - Re-export query_tasks use case (client-query-uow).
#   PREVIOUS_CHANGE: v1.3.0 - Re-export AllocationTracker (cloud-provisioner-pure).
# END_CHANGE_SUMMARY
