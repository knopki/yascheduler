# FILE: yascheduler/adapters/persistence/sql_loader.py
# VERSION: 1.0.0
...
#   LAST_CHANGE: v1.0.0 - Extract load_query from __init__.py into dedicated module.
# END_CHANGE_SUMMARY
...
def load_query(name: str) -> str:
    """Return the content of adapters/persistence/sql/<name>.sql."""
