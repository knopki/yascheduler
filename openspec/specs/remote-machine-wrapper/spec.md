...
Refactor RemoteMachine as a thin compatibility wrapper that delegates all SSH
operations to SSHMachineGateway, preserving existing cloud module API surface.
