...
The project SHALL provide a session-scoped pytest fixture that starts a PostgreSQL container via testcontainers, applies the schema from `schema.sql`, and yields a live `DB` instance.
