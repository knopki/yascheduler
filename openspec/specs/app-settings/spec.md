...
Local settings and remote defaults value objects consumed by the
orchestrator and composition root, defined as stdlib frozen dataclasses in
the domain layer with no INI parsing methods and no attrs dependency.
