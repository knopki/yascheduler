# FILE: yascheduler/adapters/cloud/providers/upcloud.py
# VERSION: 1.6.0
#
...
#   LAST_CHANGE: v1.6.1 - Relocated from yascheduler/clouds/upcloud.py; optional SDK imports; updated internal imports.
