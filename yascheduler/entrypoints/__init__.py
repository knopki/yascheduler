...
#   LAST_CHANGE: v2.2.0 - consolidate-daemon-entrypoints: daemonize is now a resident of entrypoints/cli/ (moved from infra/cli/); yascheduler/infra/cli/ is liquidated; no deferred infra/cli migration remains.
