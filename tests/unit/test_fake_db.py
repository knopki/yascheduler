...
async def test_fake_db_add_get_task(fake_db: FakeDB) -> None:
...
async def test_fake_db_add_task_increments_id(fake_db: FakeDB) -> None:
...
async def test_fake_db_add_get_all_nodes(fake_db: FakeDB) -> None:
...
async def test_fake_db_status_transitions(fake_db: FakeDB) -> None:
...
async def test_fake_db_get_node_none(fake_db: FakeDB) -> None:
...
async def test_fake_db_get_task_none(fake_db: FakeDB) -> None:
...
async def test_fake_db_enable_disable_node(fake_db: FakeDB) -> None:
...
async def test_fake_db_remove_node(fake_db: FakeDB) -> None:
...
async def test_fake_db_set_task_error(fake_db: FakeDB) -> None:
