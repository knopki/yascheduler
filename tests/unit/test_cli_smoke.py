...
#   LAST_CHANGE: v1.0.0 - Initial CLI smoke tests for v2.0.0.
# END_CHANGE_SUMMARY
...
def test_utils_import_does_not_import_scheduler():
    ...
    try:
        import yascheduler.utils  # noqa: F401

        assert "yascheduler.scheduler" not in sys.modules, (
            "Importing yascheduler.utils should not transitively import yascheduler.scheduler"
        )
    finally:
