...
Concrete connected-machine entity handle: domain identity, connect-time config, adapter-derived accessors, base SSH primitives, and per-session monitor mechanism.
