# FILE: yascheduler/infra/ssh/helpers.py
# VERSION: 1.0.1
#
# START_MODULE_CONTRACT
#   PURPOSE: Shared SSH infrastructure for infra/ssh/ — platform adapter registry, SSH client factory, connection options, and helper functions.
...
#   PREVIOUS_CHANGE: v1.0.0 - Extracted shared SSH infrastructure from remote_machine/remote_machine.py.
# END_CHANGE_SUMMARY
