# FILE: yascheduler/adapters/cloud/providers/vastai.py
# VERSION: 1.6.0
#
...
#   LAST_CHANGE: v1.6.0 - Imported from PR-154; relocated to adapters/cloud/providers/; updated imports; added GRACE-lite markup.
# END_CHANGE_SUMMARY
